<%@ Page Title="" Language="C#" MasterPageFile="~/MPPre.master" AutoEventWireup="true"
    CodeFile="SolicitudPre2.aspx.cs" Inherits="SolicitudPre" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlSolicitud" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="6" Width="950px"
                    Height="500px">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" 
                                                        ControlToValidate="txtApPaterno" ErrorMessage="tu apellido paterno." 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" 
                                                        ...
                                                        ErrorMessage="Datos personales: Escribe tu apellido materno." ForeColor="Red" 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtSecundaria"
                                            ErrorMessage="Escuela de Procedencia: Escribe el nombre." ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                        <asp:CompareValidator ID="CompareValidator19" runat="server" ControlToValidate="txtSecundaria"
                                            ErrorMessage="Escuela de Procedencia: Escribe el nombre de la secundaria" ForeColor="Red"
                                            Operator="NotEqual" SetFocusOnError="True" ValueToCompare="Escribe aquí el nombre de la secundaria">*</asp:CompareValidator>
                                    </td>
                                </tr>
                            </table>
                        </ContentTemplate>
