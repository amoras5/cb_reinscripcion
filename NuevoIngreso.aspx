<%@ Page Title="" Language="C#" MasterPageFile="~/MPPre.master" AutoEventWireup="true"
    CodeFile="NuevoIngreso.aspx.cs" Inherits="NuevoIngreso" %>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="text-align: center">
                        <h1>
                            Solicitud de Preinscripción Nuevo Ingreso</h1>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <table style="width: 100%">
                    <tr>
                        ...
                        <td>
                            Antes de continuar, conoce el proceso paso a paso <a href="Imagenes/PasoAPasoPreInscripcion.jpg" style="font-weight: 700">AQUÍ</a> </td>
                    </tr>
                    <tr>
                        <td class="formLabel" style="width: 224px">
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td>
                            La guía de estudio del examen diagnóstico, la puedes bajar <a href="GuiaDeEstudios2015A.pdf"
                                style="font-weight: 700" target="_blank">AQUÍ</a>
                        </td>
                    </tr>
                    <tr>
